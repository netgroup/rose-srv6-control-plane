...
if controller_path == '':
    print('Error : Set controller_path variable in remove_tunnel_r1r7r8.py')
    sys.exit(-2)

if not os.path.exists(controller_path):
    print('Error : controller_path variable in '
          'remove_tunnel_r1r7r8.py points to a non existing folder\n')
    sys.exit(-2)
...
if proto_path == '':
    print('Error : Set proto_path variable in remove_tunnel_r1r7r8.py')
    sys.exit(-2)
